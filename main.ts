// a function for when Player overlaps Enemy
// call the function when the overlaps happens
sprites.onOverlap(SpriteKind.Player, SpriteKind.Enemy, function (sprite, otherSprite) {
    preppy.setPosition(randint(10, 120), randint(10, 100))
    music.smallCrash.play()
    info.changeScoreBy(2)
})
let preppy: Sprite = null
...
// setup the game with this information
// Player information
let lana_del_rey_stan = sprites.create(assets.image`Smiley`, SpriteKind.Player)
controller.moveSprite(lana_del_rey_stan)
// Enemy Information
preppy = sprites.create(assets.image`Vampire`, SpriteKind.Enemy)
preppy.setPosition(randint(10, 120), randint(10, 100))
info.setScore(0)
